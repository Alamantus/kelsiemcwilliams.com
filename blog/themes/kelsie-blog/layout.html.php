...
<head>
    ...
    <!-- Global CSS -->
    <link rel="stylesheet" href="<?php echo site_url();?>themes/kelsie-blog/css/bootstrap.min.css">   
    <!-- Plugins CSS -->
    <link rel="stylesheet" href="<?php echo site_url();?>themes/kelsie-blog/css/font-awesome.min.css">
    <!-- Theme CSS -->  
    <link id="theme-style" rel="stylesheet" href="<?php echo site_url();?>themes/kelsie-blog/css/styles.css">
...
<?php if (login()) { toolbar(); } ?>
    ...
    <header class="header">
        <div class="container">                       
            <div class="logo pull-left"><img class="logo-image" src="<?php echo site_url();?>themes/kelsie-blog/images/logo.png"/></div>
    ...
    <!-- Javascript -->          
    <script type="text/javascript" src="<?php echo site_url();?>themes/kelsie-blog/js/jquery-latest.min.js"></script>
    <script type="text/javascript" src="<?php echo site_url();?>themes/kelsie-blog/js/bootstrap.min.js"></script>
